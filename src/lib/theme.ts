/**
 * The same four-theme system as Reading Cabin (see its src/lib/theme.ts),
 * trimmed to just what the app shell needs — Almanac has no reader-style
 * surface that needs its own page-filter/chrome tokens.
 */
