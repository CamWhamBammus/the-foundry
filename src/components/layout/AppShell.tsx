...
import { Award, Gamepad2, Monitor } from "lucide-react";
import { cn } from "@/lib/utils";
import { useTheme } from "@/hooks/useTheme";
import { THEME_PREFERENCE_LABELS, THEME_PREFERENCE_ORDER, THEME_SWATCH } from "@/lib/theme";

const NAV_ITEMS = [
  { href: "/", label: "Foundry", icon: Gamepad2 },
  { href: "/shelf", label: "Shelf", icon: Award },
];
      ...
      */}
      <aside className="flex w-56 shrink-0 flex-col border-r border-[#7a5738]/12 bg-[#10190f] text-[#f6efe1]">
        <div className="flex items-center gap-2 px-5 py-6">
          <Gamepad2 size={20} className="text-[#cf9c52]" strokeWidth={1.75} />
          <span className="font-serif text-[1.05rem] tracking-tight">The Foundry</span>
        </div>
